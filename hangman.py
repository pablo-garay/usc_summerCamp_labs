...
class Ui_Hangman(object):
    def setupUi(self, Hangman):
        Hangman.setObjectName(_fromUtf8("Hangman"))
        Hangman.resize(600, 544)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Hangman.sizePolicy().hasHeightForWidth())
        Hangman.setSizePolicy(sizePolicy)
        self.centralwidget = QtGui.QWidget(Hangman)
    ...
    def retranslateUi(self, Hangman):
        Hangman.setWindowTitle(_translate("Hangman", "Hangman", None))
...
def start():
    ...
    filehang=open('HangDict.txt','r')
    secretWord=list(filehang)[random.randrange(113713)].rstrip()
    filehang.close()
